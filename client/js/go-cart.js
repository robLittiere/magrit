(function (global, factory) {
  ...
  var GoCart = function () {
    ...
    return /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(GoCart) {
        var Module, readyPromiseResolve, readyPromiseReject, moduleOverrides, quit_, ENVIRONMENT_IS_WEB, ENVIRONMENT_IS_WORKER, ENVIRONMENT_IS_NODE, scriptDirectory, locateFile, read_, readAsync, readBinary, logExceptionOnExit, _yield$import, createRequire, require$1, fs, nodePath, out, err, wasmBinary, noExitRuntime, wasmMemory, ABORT, assert, UTF8Decoder, UTF8ArrayToString, UTF8ToString, stringToUTF8Array, stringToUTF8, lengthBytesUTF8, buffer, HEAP8, HEAPU8, HEAP16, HEAPU16, HEAP32, HEAPU32, HEAPF32, HEAPF64, updateGlobalBufferAndViews, __ATPRERUN__, __ATINIT__, __ATPOSTRUN__, keepRuntimeAlive, preRun, initRuntime, postRun, addOnPreRun, addOnInit, addOnPostRun, runDependencies, runDependencyWatcher, dependenciesFulfilled, getUniqueRunDependency, addRunDependency, removeRunDependency, abort, dataURIPrefix, isDataURI, isFileURI, wasmBinaryFile, getBinary, getBinaryPromise, createWasm, tempDouble, tempI64, ExitStatus, callRuntimeCallbacks, setErrNo, PATH, getRandomDevice, PATH_FS, intArrayFromString, TTY, mmapAlloc, MEMFS, asyncLoad, FS, SYSCALLS, ___syscall_fcntl64, ___syscall_ioctl, ___syscall_openat, __embind_register_bigint, getShiftFromSize, embind_init_charCodes, embind_charCodes, readLatin1String, awaitingDependencies, registeredTypes, typeDependencies, char_0, char_9, makeLegalFunctionName, createNamedFunction, extendError, BindingError, throwBindingError, registerType, __embind_register_bool, emval_free_list, emval_handle_array, __emval_decref, count_emval_handles, get_first_emval, init_emval, Emval, simpleReadValueFromPointer, __embind_register_emval, floatReadValueFromPointer, __embind_register_float, integerReadValueFromPointer, __embind_register_integer, __embind_register_memory_view, __embind_register_std_string, UTF16Decoder, UTF16ToString, stringToUTF16, lengthBytesUTF16, UTF32ToString, stringToUTF32, lengthBytesUTF32, __embind_register_std_wstring, __embind_register_void, nowIsMonotonic, __emscripten_get_now_is_monotonic, _abort, _emscripten_date_now, _emscripten_memcpy_big, getHeapMax, emscripten_realloc_buffer, _emscripten_resize_heap, _proc_exit, exitJS, _exit, _fd_close, doReadv, _fd_read, convertI32PairToI53Checked, _fd_seek, doWritev, _fd_write, getCFunc, writeArrayToMemory, ccall, FSNode, readMode, writeMode, asmLibraryArg, _malloc, _free, ___errno_location, stackSave, stackRestore, stackAlloc, calledRun, run;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                get_first_emval = function _get_first_emval() {
                ...
                getRandomDevice = function _getRandomDevice() {
                ...
                getBinaryPromise = function _getBinaryPromise() {
                ...
                logExceptionOnExit = function _logExceptionOnExit(e) {
